...
public class PostMessageTest {
    ...
    public void shouldSuccessfullyRouteSMSToASingleWebService() throws IOException {
        ...
        verify(mMockMessageHttpClient, times(1)).postSmsToWebService(syncUrls.get(0), mMockMessage, FROM, DEVICE_ID);
    }
    ...
    public void shouldSendMessageWhenBlackListIsEnabledButNoBlacklistedNumber() {
        ...
        stubNeedMethodsRouteSms(syncUrls, true, false, true, SyncUrl.Status.ENABLED, false, true, false, false);
