...
import com.maishapay.smssync.domain.util.DataFormatUtil;
...
public class MessageHttpClient extends BaseHttpClient {
    ...
    private void initRequest(SyncUrl syncUrl, Message message, String toNumber, String deviceId) {
        ...
        addParam(syncScheme.getKey(SyncScheme.SyncDataKey.SENT_TIMESTAMP), String.valueOf(message.getMessageDate().getTime()));
