...
import com.maishapay.smssync.data.entity.MessageResult;
 ...
 * <p/>
 * POST ?task=sent queued_messages {@link #sendQueuedMessagesPOSTRequest(com.maishapay.smssync.data.entity.SyncUrl,
 * com.maishapay.smssync.data.entity.QueuedMessages)} POST ?task=results message_results {@link
 * #sendMessageResultPOSTRequest(com.maishapay.smssync.data.entity.SyncUrl, List)} GET
 * ?task=results {@link #sendMessageResultGETRequest(com.maishapay.smssync.data.entity.SyncUrl)}
 */
@Singleton
