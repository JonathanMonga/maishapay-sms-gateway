 ...
 * <p/>
 * POST ?task=sent queued_messages {@link #sendQueuedMessagesPOSTRequest(com.maishapay.smssync.models.SyncUrl,
 * com.maishapay.smssync.models.QueuedMessages)} POST ?task=results message_results {@link
 * #sendMessageResultPOSTRequest(com.maishapay.smssync.models.SyncUrl, List)} GET
 * ?task=results {@link #sendMessageResultGETRequest(com.maishapay.smssync.models.SyncUrl)}
 */
@Singleton
