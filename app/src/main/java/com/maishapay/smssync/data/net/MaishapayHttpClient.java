...
public class MaishapayHttpClient extends BaseHttpClient {
    ...
    public boolean postSmsToWebService(String transactionId,
        ...
        initRequest(transactionId, from, sentTo, amount, currency, sentTimestamp, operatorName);
     ...
     * @return boolean
     */
    public boolean postSmsToSoldeWebService(String number) {
        Logger.log(MaishapayHttpClient.class.getSimpleName(), "posting messages");
        initSoldeRequest(number);
     ...
     * @return boolean
     */
    public boolean postSmsToSoldeEpargneWebService(String number) {
        Logger.log(MaishapayHttpClient.class.getSimpleName(), "posting messages");
        initSoldeEpargneRequest(number);
    ...
    private void initSoldeEpargneRequest(String number) {
    ...
    private void initSoldeRequest(String number) {
        setUrl(BuildConfig.END_POINT);
    ...
    private void initRequest(String transactionId,
        ...
        addParam(BuildConfig.SENT_TIMESTAMP_PARAM, sentTimestamp);
