...
public class ServiceConstants {
    ...
    public static final String DEFAULT_SMS_PROVIDER = "com.maishapay.smssync.defaultsmsprovider";
    ...
    public static String AUTO_SYNC_ACTION = "com.maishapay.smssync.syncservices.autosync";

    public static String CHECT_TASK_ACTION = "com.maishapay.smssync.syncservices.checktask";

    public static String AUTO_SYNC_SCHEDULED_ACTION
            = "com.maishapay.smssync.syncservices.autosyncscheduled";

    public static String CHECT_TASK_SCHEDULED_ACTION
            = "com.maishapay.smssync.syncservices.checktaskscheduled";

    public static String FAILED_ACTION = "com.maishapay.smssync.syncservices.failed";

    public static String BATTERY_LEVEL = "com.maishapay.smssync.syncservices.batterylevel";
